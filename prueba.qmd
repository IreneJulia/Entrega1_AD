...
par(plt = c(0.1,0.9,0.25,0.8))
par(mfrow=c(2,2))
boxplot(bill_length_mm~sex, data = ping_adelie, ylab = " ", main = "Longitud del pico", col = c("tan4", "steelblue1"), xlab = "")
boxplot(bill_depth_mm~sex, data = ping_adelie, ylab = " ", main = "Anchura del pico", col = c("tan4", "steelblue1"), xlab = "")
boxplot(flipper_length_mm~sex, data = ping_adelie, ylab = " ", main = "Longitud de la aleta", col = c("tan4", "steelblue1"), xlab = "")
boxplot(body_mass_g~sex, data = ping_adelie, ylab = " ", main = "Masa corporal", col = c("tan4", "steelblue1"), xlab = "")
```
...
par(plt = c(0.1,0.9,0.25,0.8))
par(mfrow=c(2,2))
boxplot(bill_length_mm~sex, data = ping_chinstrap, ylab = " ", main = "Longitud del pico", col = c('violetred3','springgreen'), xlab = "")
boxplot(bill_depth_mm~sex, data = ping_chinstrap, ylab = " ", main = "Anchura del pico", col = c('violetred3','springgreen'), xlab = "")
boxplot(flipper_length_mm~sex, data = ping_chinstrap, ylab = " ", main = "Longitud de la aleta", col = c('violetred3','springgreen'), xlab = "")
boxplot(body_mass_g~sex, data = ping_chinstrap, ylab = " ", main = "Masa corporal", col = c('violetred3','springgreen'), xlab = "")
```
...
par(plt = c(0.1,0.9,0.25,0.8))
par(mfrow=c(2,2))
boxplot(bill_length_mm~sex, data = ping_gentoo, ylab = " ", main = "Longitud del pico", col = c("royalblue4","gold2"), xlab = "")
boxplot(bill_depth_mm~sex, data = ping_gentoo, ylab = " ", main = "Anchura del pico", col = c("royalblue4","gold2"), xlab = "")
boxplot(flipper_length_mm~sex, data = ping_gentoo, ylab = " ", main = "Longitud de la aleta", col = c("royalblue4","gold2"), xlab = "")
boxplot(body_mass_g~sex, data = ping_gentoo, ylab = " ", main = "Masa corporal", col = c("royalblue4","gold2"), xlab = "")
```
