...
>>>>>>> f6a795281a37d65dbfa5a3adcf98c13cf85896fb
...
par(plt = c(0.1,0.9,0.25,0.8))
par(mfrow=c(2,2))
boxplot(bill_length_mm~sex, data = ping_adelie, ylab = " ", main = "Longitud del pico", col = hcl.colors(3, "Earth"), xlab = "")
boxplot(bill_depth_mm~sex, data = ping_adelie, ylab = " ", main = "Anchura del pico", col = hcl.colors(3, "Earth"), xlab = "")
boxplot(flipper_length_mm~sex, data = ping_adelie, ylab = " ", main = "Longitud de la aleta", col = hcl.colors(3, "Earth"), xlab = "")
boxplot(body_mass_g~sex, data = ping_adelie, ylab = " ", main = "Masa corporal", col = hcl.colors(3, "Earth"), xlab = "")
```
...
par(plt = c(0.1,0.9,0.25,0.8))
par(mfrow=c(2,2))
boxplot(bill_length_mm~sex, data = ping_chinstrap, ylab = " ", main = "Longitud del pico", col = hcl.colors(3, "Red-Green"), xlab = "")
boxplot(bill_depth_mm~sex, data = ping_chinstrap, ylab = " ", main = "Anchura del pico", col = hcl.colors(3, "Red-Green"), xlab = "")
boxplot(flipper_length_mm~sex, data = ping_chinstrap, ylab = " ", main = "Longitud de la aleta", col = hcl.colors(3, "Red-Green"), xlab = "")
boxplot(body_mass_g~sex, data = ping_chinstrap, ylab = " ", main = "Masa corporal", col = hcl.colors(3, "Red-Green"), xlab = "")
```
...
par(plt = c(0.1,0.9,0.25,0.8))
par(mfrow=c(2,2))
boxplot(bill_length_mm~sex, data = ping_gentoo, ylab = " ", main = "Longitud del pico", col = hcl.colors(3, "Cividis"), xlab = "")
boxplot(bill_depth_mm~sex, data = ping_gentoo, ylab = " ", main = "Anchura del pico", col = hcl.colors(3, "Cividis"), xlab = "")
boxplot(flipper_length_mm~sex, data = ping_gentoo, ylab = " ", main = "Longitud de la aleta", col = hcl.colors(3, "Cividis"), xlab = "")
boxplot(body_mass_g~sex, data = ping_gentoo, ylab = " ", main = "Masa corporal", col = hcl.colors(3, "Cividis"), xlab = "")
```
