...
A continuación, realizaremos unos histogramas de las variables `bill_length_mm`, `bill_depth_mm`, `flipper_length_mm` y `body_mass_g` para ver a simple vista la distribución de la población. Se trata de las características fisiológicas del animal.
...
Realicemos una tabla que nos de información numérica de estas cuatro variables cuantitativas.
